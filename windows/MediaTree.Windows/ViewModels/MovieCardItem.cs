...
public sealed partial class MovieCardItem : ObservableObject
{
    ...
    public bool IsEpisode => string.Equals(Movie.TmdbType, "tv", StringComparison.OrdinalIgnoreCase) && Movie.TmdbEpisode.HasValue;
    ...
    public string Title => IsEpisode
        ...
        : Movie.BestTitle;
    public string Subtitle => IsEpisode ? Movie.Code : string.IsNullOrWhiteSpace(Movie.ReleaseDate) ? Movie.Genre : Movie.ReleaseDate;
