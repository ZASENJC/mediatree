...
from .config import settings, logger, setup_file_logging, close_file_logging
from .updater import mark_update_success_after_restart
...
_has_app_auth = has_app_auth
_require_media_access = require_media_access
_has_media_access = has_media_access
