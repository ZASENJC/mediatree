...
- `/api/folders` 文件夹树节点新增 `video_count`，用于表示源文件夹下实际主视频数量；首页目录卡片可显示剧集文件夹的真实集数，媒体库总数继续使用按季/媒体去重的 `movie_count`
- Windows 桌面版首页目录卡片改为显示剧集文件夹视频数量；设置页媒体库列表继续显示 `movie_count` 部数
