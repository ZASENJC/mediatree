        ...
        <form onSubmit={handleSave} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-1.5 bg-dark-700 border border-dark-600 rounded text-sm text-white focus:outline-none focus:border-blue-500"
            />
          </div>
          <div>
          ...
          <div className="flex gap-3 pt-2">
            <button type="button" onClick={onClose}
              className="flex-1 py-2 bg-dark-700 hover:bg-dark-600 rounded text-sm transition-colors text-gray-400">
              取消
            </button>
            <button type="submit" disabled={saving}
              className="flex-1 py-2 bg-blue-600 hover:bg-blue-500 rounded text-sm transition-colors disabled:opacity-50">
              {saving ? '保存中...' : '保存'}
            </button>
          </div>
        </form>
